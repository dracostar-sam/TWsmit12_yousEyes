...
namespace WebApplication1.Services
{
    public class MembersDBService
    {
        ...
        public void Register(Members newMember)
        {
            ...
            //sql新增語法
            //IsAdmin 預設為0
            string sql = $@" INSERT INTO Members (Account,Password,Name,Email,AuthCode,IsAdmin,MyPhone,MyAddress) VALUES 
('{newMember.Account}','{newMember.Password}','{newMember.Name}','{newMember.Email}','{newMember.AuthCode}','0','{newMember.MyPhone}','{newMember.MyAddress}') ";
            //確保程式不會因執行錯誤而整個中斷
            try
            {
                //開啟資料庫連線
